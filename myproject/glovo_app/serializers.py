...
class StoreMenuListSerializer(serializers.ModelSerializer):
    storeproduct = ProductSerializer(many=True, read_only=True)
    class Meta:
        model = StoreMenu
        fields = ['id','menu_name',  'storeproduct']
...
class StoreDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Store
        fields = ['store_name', 'store_photo','category', 'description',
                  'StoreMenu', 'owner','store_review','created_date',
                  'store_contact','store_address',]